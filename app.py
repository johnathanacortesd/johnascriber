...
def stream_response(completion):
    """Helper function to collect streaming response chunks into a single string."""
    full_response = ""
...
# --- FUNCIONES DE ANÁLISIS (ACTUALIZADAS CON LLAMA-3.3-70B-VERSATILE) ---
...
def generate_summary(transcription_text, client):
    try:
        ...
        with st.spinner("📝 Generando resumen en streaming..."):
            summary = stream_response(completion)
        return summary
...
<p><strong>Transcriptor Pro - Johnascriptor - v2.4.3 (Actualizado con Llama-3.3)</strong> - Desarrollado por Johnathan Cortés 🤖</p>
<p style='font-size: 0.85rem;'>✨ Con búsqueda contextual mejorada, Q&A interactivo, extracción de entidades en español y Llama-3.3-70b-versatile</p>
